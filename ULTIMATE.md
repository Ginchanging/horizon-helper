...
| `inputMethod` | `SendInputScanCode` | 按键后端,默认扫描码 `SendInput`(游戏识别最稳,避免 `SendKeys` 偶发多发/漏发键);另有 `SendInputVirtualKey` / `SendKeys` 兜底 |
